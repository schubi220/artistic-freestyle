...
urlpatterns = [
    ...
    re_path('sheed(?P<year>(2018|2019|2024)).pdf', views.inputpdf, name='inputpdf'),
    ...
    path('display/controll', views.displayControll, name='displayControll'),
    path('display/time', views.displayTime, name='displayTime'),
